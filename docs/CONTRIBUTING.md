...
Package Discovery could always use more documentation, whether as part of the
official Package Discovery docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `Package Discovery` for local development.

1. Fork the `package-discovery` repo on GitHub.
...
[GitHub Issues]: https://github.com/yukihiko-shinoda/package-discovery/issues
